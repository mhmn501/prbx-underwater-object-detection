...
# === CONFIGURATION ===
DATASET_DIR = "C:/Users/Haiqal/Desktop/PRBX/datasets/Fish4K-Split"  # Directory containing train/val/test splits
BATCH_SIZE = 32
NUM_CLASSES = 23
EPOCHS = 50
LEARNING_RATE = 1e-3
...
CHECKPOINT_DIR = "C:/Users/Haiqal/Desktop/PRBX/EfficientNet_Implementation/efficientnet_checkpoints"
os.makedirs(CHECKPOINT_DIR, exist_ok=True)
RESULTS_CSV = "C:/Users/Haiqal/Desktop/PRBX/EfficientNet_Implementation/efficientnet_training_log.csv"
PLOTS_DIR = "C:/Users/Haiqal/Desktop/PRBX/EfficientNet_Implementation/efficientnet_plots"
os.makedirs(PLOTS_DIR, exist_ok=True)

# === DATASET PREPARATION ===
def prepare_dataloaders():
    """
    Prepare training, validation, and test dataloaders with relevant augmentations.
    """
    ...
    image_datasets = {
        x: datasets.ImageFolder(os.path.join(DATASET_DIR, x),
                                data_transforms[x]) 
    ...
    class_names_index = image_datasets['train'].classes
...
def initialize_model():
    """
    Load a pretrained EfficientNet and modify the classifier head for custom classes.
    """
...
def predict_batch_images(model, dataset, class_names, num_images=16, num_grids=10):
    ...
    for grid_num in range(1, num_grids + 1):
        ...
        save_path = os.path.join(PLOTS_DIR, f"efficientnet_test_predictions_grid{grid_num}.jpg")
